...
public:
  ...
  //  void aFenotipo();
    ...
    QVector<TemplatePiezas> mostrarFenotipo() {return _fenotipo;}
...
void GenomaVidrio::mutar()
{
    ...
    if (_fenotipo.at(tipoPieza).getMutado() < 0){ //seria que no muto nunca
        ...
        _fenotipo.at(tipoPieza).setearCantidad(_fenotipo.at(tipoPieza).getCantidad()-1);
        _fenotipo.at(tipoPieza).setearMutado(auxiliar.tipo());
        ...
        _fenotipo.at(tipoPieza).setearCantidad(_fenotipo.at(tipoPieza).getCantidad()-1);
        int indiceDelMutado = _fenotipo.at(tipoPieza).getMutado()-1;
        _fenotipo.at(indiceDelMutado).setearCantidad(_fenotipo.at(indiceDelMutado).getCantidad()+1);
