...
int main(int argc, char *argv[])
{
    ...
    QVector<int> tamano_vecindad1 = distribucionEquitativa( epocas.at( 0 ), 3 ,tamano_vecindad_inicial );
    ...
    // Etapa de transición -----------------------------------------------------------------------------
    QVector<int> tamano_vecindad2 = distribucionEquitativa( epocas.at( 1 ), 2, 3);
