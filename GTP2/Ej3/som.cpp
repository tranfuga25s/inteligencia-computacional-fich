...
void SOM::setearClase(int fila, int columna, int clase)
{
    _clases[fila][columna] = clase;
}

int SOM::devolverClasesSalida(int fila, int columna)
{
    return _clases.at(fila).at(columna);
}
